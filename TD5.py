...
class FenetrePrincipale(Tk): 
    ...
    def NouvellePartie(self):
        ...
        self.__AfficheScore.config(text = 'Score = 1000')#Initialisation du Score à 1000
    ...
    def traitement(self,lettre):#Grise les lettres cliquées        
        ...
        if a==False:#Dessin du pendu si mauvaise lettre et diminution du score
            ...
            self.__score-=100 #le score diminue de 100 à chaque mauvaise lettre
            self.__AfficheScore.config(text = f'Score: {self.__score}')#diminution du score
            print(self.__count,self.__score)
        
        if self.__count==10:#Défaite au delà de 10 tentatives          
